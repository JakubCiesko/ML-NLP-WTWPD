...
\setbeamercolor{block alerted title}{fg=white,bg=ngreen!70} % Updated color
\setbeamercolor{block alerted body}{fg=black,bg=ngreen!10} % Updated color
...
\begin{center}
    \includegraphics[width=1.0\linewidth]{figures/figure1.png} % Increased figure width
\end{center}
