...
class GAN(torch.nn.Module):
    def __init__(self, input_dim=300, output_dim=300, hidden_dim=2048, dropout_rate=0.1, smoothing_coeff=0.2, leaky_relu_slope=0.1):
        super().__init__()
        self.mapping = Mapping(input_dim, output_dim)
